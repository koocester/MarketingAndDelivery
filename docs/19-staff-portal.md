...
- **Academy auth in depth** (sign-in, sessions, the gate stack, `is_founder()`): [portal/04-academy-auth.md](../portal/04-academy-auth.md)
- **Change process** (the SDLC applied to portal changes): [portal/05-change-process.md](../portal/05-change-process.md)
- **The actual source** (committed, sanitized): [portal/src/](../portal/src/README.md)
