...
| 2026-08-05 | Faiz | **Dept buttons = plain section navigation, consolidated overlay views RETIRED** — "it should not be any different from the main one." Anything that existed only in an overlay moves into the main flow. |
